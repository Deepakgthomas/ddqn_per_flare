...
class CnnDQN(nn.Module):
    def __init__(self, obs_shape, feature_dim,
        ...
        self.convs = nn.ModuleList(
            [nn.Conv2d(self.image_channel, num_filters, kernel_size=8, stride=4)]
        )
        self.convs.append(nn.Conv2d(num_filters, num_filters*2, kernel_size=4, stride=2))
        self.convs.append(nn.Conv2d(num_filters*2, num_filters*2, kernel_size=3, stride=1))
